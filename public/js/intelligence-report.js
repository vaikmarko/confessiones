...
class IntelligenceReport {
  ...
  generateMetadata() {
    const totalDataPoints = this.userData.stories.length + 
                           this.userData.conversations.length + 
                           Object.keys(this.userData.assessments).length;
    
    return {
      generatedAt: new Date().toISOString(),
      dataPoints: totalDataPoints,
      analysisVersion: '3.1',
      confidenceLevel: Math.min(95, 60 + (this.userData.userStats.totalConversations * 2) + 
                               (Object.keys(this.userData.assessments).length * 5)),
  ...
  determineArchetype() {
    const archetypes = {
      'The Deep Thinker': {
        ...
        characteristics: [
          ...
          'Processes emotions cognitively'
        ]
      },
      'The Connected Empath': {
        ...
        characteristics: [
          ...
          'Processes information through relational lens',
      ...
      'The Creative Explorer': {
        ...
        probability: 0,
        characteristics: [
          'Thrives on novelty and innovation',
      ...
      'The Intuitive Guide': {
        ...
        probability: 0,
        characteristics: [
          'Trusts inner knowing and intuition',
          'Sees bigger picture patterns',
    ...
    const scoringRules = {
      'The Deep Thinker': [
        { pattern: /think|analyze|consider|reflect|ponder|philosophical|abstract/g, weight: 3 },
        { pattern: /why|because|therefore|thus|hence|logic/g, weight: 2 },
        { pattern: /pattern|system|structure|framework|concept/g, weight: 2 }
      ],
      'The Connected Empath': [
        { pattern: /feel|emotion|heart|love|relationship|connection|together/g, weight: 3 },
        { pattern: /empathy|understand|compassion|care|support|help/g, weight: 2 },
        { pattern: /we|us|together|harmony|community|share/g, weight: 2 }
      ],
      'The Creative Explorer': [
        { pattern: /create|art|imagine|dream|possibility|new|innovative/g, weight: 3 },
        { pattern: /explore|discover|adventure|curious|wonder|what if/g, weight: 2 },
        { pattern: /inspiration|vision|creative|original|unique/g, weight: 2 }
      ],
      'The Practical Adapter': [
        { pattern: /practical|solution|work|adapt|flexible|realistic/g, weight: 3 },
        { pattern: /balance|manage|organize|plan|efficient|effective/g, weight: 2 },
        { pattern: /change|adjust|modify|improve|fix|resolve/g, weight: 2 }
      ],
      'The Independent Analyst': [
        { pattern: /independent|alone|self|objective|data|evidence|fact/g, weight: 3 },
        { pattern: /analyze|research|study|investigate|examine/g, weight: 2 },
        { pattern: /logical|rational|systematic|methodical|precise/g, weight: 2 }
      ],
      'The Intuitive Guide': [
        { pattern: /intuition|spiritual|wisdom|insight|inner|soul/g, weight: 3 },
        { pattern: /meaning|purpose|deeper|transcend|transform/g, weight: 2 },
        { pattern: /guide|mentor|teach|inspire|enlighten/g, weight: 2 }
      ]
    };
  ...
  calculateSelfAwareness() {
    ...
    const selfAwarenessPattterns = [
      /i realize|i notice|i understand|i recognize|i see that/g,
      /my pattern|my tendency|my habit|my behavior/g,
      /i feel|i think|i believe|i value/g,
      /reflection|introspection|self-aware|mindful/g
    ];
    ...
    return {
      score: Math.min(98, score), // Never 100% - always room for growth
  ...
  calculateEmotionalIQ() {
    ...
    const emotionalPatterns = [
      /feel|emotion|emotional|mood|sentiment/g,
      /empathy|compassion|understanding|support/g,
      /anger|joy|sadness|fear|surprise|disgust/g,
      /regulate|manage|cope|handle|process/g
    ];
  ...
  calculateCognitiveComplexity() {
    ...
    const complexityPatterns = [
      /however|although|despite|nevertheless|on the other hand/g,
      /complex|nuanced|multifaceted|intricate|sophisticated/g,
      /perspective|viewpoint|angle|dimension|aspect/g,
      /paradox|contradiction|irony|ambiguity/g
    ];
  ...
  calculateRelationshipIQ() {
    ...
    const relationshipPatterns = [
      /relationship|friend|family|partner|colleague/g,
      /communicate|listen|understand|connect|bond/g,
      /conflict|resolution|compromise|negotiate/g,
      /trust|intimacy|vulnerability|openness/g
    ];
  ...
  calculateAdaptability() {
    ...
    const adaptabilityPatterns = [
      /adapt|adjust|flexible|change|evolve/g,
      /learn|grow|develop|improve|progress/g,
      /challenge|difficulty|obstacle|problem/g,
      /solution|alternative|option|approach/g
    ];
  ...
  calculateCreativity() {
    ...
    const creativityPatterns = [
      /create|creative|imagine|envision|invent/g,
      /art|artistic|design|aesthetic|beautiful/g,
      /novel|unique|original|innovative|fresh/g,
      /inspiration|muse|spark|idea|vision/g
    ];
  ...
  calculateResilience() {
    ...
    const resiliencePatterns = [
      /overcome|persevere|persist|endure|survive/g,
      /strength|courage|brave|resilient|tough/g,
      /bounce back|recover|heal|rebuild/g,
      /learned|grew|stronger|wiser/g
    ];
  ...
  calculateAuthenticity() {
    ...
    const authenticityPatterns = [
      /authentic|genuine|real|true|honest/g,
      /values|beliefs|principles|integrity/g,
      /myself|who i am|my identity|my truth/g,
      /vulnerable|open|transparent|raw/g
    ];
  ...
  predictGrowthPath() {
    return {
      ...
      keyMilestones: [
        'Complete major assessments',
        'Develop consistent self-reflection practice',
  ...
  generateRecommendations() {
    return {
      immediate: [
        'Complete remaining personality assessments',
        'Start a daily reflection practice',
        'Share one insight with a trusted friend'
      ],
      shortTerm: [
        'Explore creative expression formats',
        'Practice vulnerability in safe relationships',
        'Set up regular check-ins with yourself'
      ],
      longTerm: [
        'Consider becoming a mentor or guide for others',
        'Develop your unique approach to personal growth',
  ...
  generateNextLevelInsights() {
    return {
      ...
      requirements: [
        'Complete 2 more major assessments',
        'Create 5 additional stories',
        'Engage in 10 more reflective conversations'
      ],
      unlocks: [
        'Advanced relationship dynamics analysis',
        'Predictive behavioral modeling',
        'Personal archetype evolution tracking'
      ],
